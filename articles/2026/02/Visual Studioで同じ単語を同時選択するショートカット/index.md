---
title: "Visual Studioで同じ単語を同時選択するショートカット"
type: "Tech"
description: "  • https://claude.ai/chat/1a002fac-c6f3-4781-a696-c07b83f17f76
  • https://gemini.google.com/app/54c29ef85c55a114"
...
| 同じ単語を一括選択    | `Shift + Alt + ;` or `Shift + Alt + :`   | 環境によって `;` か `:` の場合がある   |
...
| 同じ単語を一括選択    | `Ctrl + Shift + L`   | `Ctrl + F2`   | `Shift + Alt + ;` or `:`   |
